    ...
    build: (action, params, videoPath) => {
        ...
        switch (action) {
            ...
            case 'voice-fx-real':
                ...
                else if(p === 'villain' || p === 'demon') af = "asetrate=44100*0.7,atempo=1.4,aecho=0.8:0.88:60:0.4";
                ...
                else if(p === 'alien') af = "vibrato=f=10:d=0.5,aecho=0.8:0.88:100:0.3";
                ...
                else if(p === 'astronaut' || p === 'walkie_talkie') af = "highpass=f=500,lowpass=f=3000,volume=1.5,aecho=0.8:0.88:50:0.2";
                else if(p === 'telephone') af = "highpass=f=400,lowpass=f=2000,volume=1.3";
                else if(p === 'glitch') af = "tremolo=f=20:d=1,aecho=0.8:0.88:5:0.5";
                else if(p === 'ghost' || p === 'poltergeist') af = "aecho=0.8:0.9:1000:0.3,vibrato=f=5:d=0.5";
                else if(p === 'zombie') af = "asetrate=44100*0.5,atempo=2.0";
                else if(p === 'killer') af = "volume=1.2,equalizer=f=100:t=q:w=1:g=5";
                else if(p === 'echo' || p === 'echo_voice') af = "aecho=0.8:0.9:1000:0.3";
                else if(p === 'cavern' || p === 'cave') af = "aecho=0.8:0.88:150:0.4,aecho=0.8:0.88:300:0.25";
                else if(p === 'hall' || p === 'cathedral') af = "aecho=0.8:0.88:200:0.3,aecho=0.8:0.88:400:0.2";
                else if(p === 'bathroom') af = "aecho=0.8:0.88:50:0.4,aecho=0.8:0.88:80:0.25";
                ...
                else if(p === 'windy') af = "highpass=f=100,lowpass=f=5000,apulsat=hz=2,tremolo=f=5:d=0.5";
                else if(p === 'fire') af = "highpass=f=100,lowpass=f=8000,aecho=0.8:0.88:10:0.1,apulsat=hz=10";
                else if(p === 'underwater') af = "lowpass=f=500,aecho=0.8:0.88:20:0.3";
                else if(p === 'space') af = "aecho=0.8:0.9:2000:0.5";
                else if(p === 'fan') af = "tremolo=f=20:d=0.8";
                else if(p === 'vibrato') af = "vibrato=f=10:d=0.5";
                else if(p === 'drunk') af = "atempo=0.9,vibrato=f=2:d=0.5,aecho=0.8:0.88:50:0.3";
