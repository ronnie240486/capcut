...
export default {
    ...
    getFFmpegFilterFromEffect: (effectId) => {
        ...
        const effects = {
            ...
            // Fixed: use max(1, ...) to prevent 0 dimensions
            'pixelate': 'scale=max(1,iw/20):max(1,ih/20):flags=nearest,scale=iw*20:ih*20:flags=neighbor',
            'block-glitch': 'scale=max(1,iw/10):max(1,ih/10):flags=nearest,scale=iw*10:ih*10:flags=neighbor',
