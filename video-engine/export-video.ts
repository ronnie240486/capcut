...
function validateAndProbe(filePath: string): Promise<{ isValid: boolean, hasAudio?: boolean }> {
...
export const handleExportVideo = async (job: any, uploadDir: string, onStart: (jobId: string, args: string[], totalDuration: number) => void) => {
    try {
