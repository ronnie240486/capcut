...
function processExportJob(jobId) {
    ...
    try {
        ...
        videoAndLayerClips.forEach((clip, vIdx) => {
            ...
            // Use safe pad syntax (-1:-1) to center the image and avoid floating point errors with odd dimensions
        ...
        if (hasAudioOutput) {
            ...
            // Map the silent audio source generated by anullsrc (which is the last input)
